...
const generateTokenAndSetCookies_1 = require("../helpers/geterateTokenAndSetCookies");
// Register new user
...
const login = async (req, res) => {
  try {
    ...
    const lowerusername = username.toLowerCase();
    const isUserExists = await user_model_1.default.findOne({
      username: lowerusername,
    });
    if (!isUserExists) {
    ...
    const isPasswordMatch = await bcrypt_1.default.compare(
      password,
